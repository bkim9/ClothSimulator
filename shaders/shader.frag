...
uniform vec3 LightDirection0 = normalize(vec3(0, 0, 3));
uniform vec3 LightDirection1 = normalize(vec3(0, 0, -3));
uniform vec3 LightColor0 = vec3(1,0,0);
uniform vec3 LightColor1 = vec3(0,1,0);
